...
\newcommand{\TTSRow}[2]{%
  ...
  \begin{minipage}[c]{17.0cm}%
    \includegraphics[height=3.00cm]{#2}%
  \end{minipage}%
}
...
این دو \textbf{هم‌ارزند}. در \code{TTS 3} هم ده واحد می‌گذرد، اما \code{a} پس
از پنج واحد رخ می‌دهد: پنهان‌سازی روی گذارهای داخلی اعمال می‌شود، نه روی
